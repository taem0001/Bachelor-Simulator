...
namespace Test {
    ...
    static constexpr std::array<TestFn, 6> ctsb_tests = {&Unit::CtsbTester::i8_test,   &Unit::CtsbTester::i16_test,
                                                         &Unit::CtsbTester::i32_test,  &Unit::CtsbTester::ui8_test,
                                                         &Unit::CtsbTester::ui16_test, &Unit::CtsbTester::ui32_test};

    static constexpr std::array<std::string, 6> ctsb_test_names = {"i8 -> i8",	"i16 -> i8",  "i32 -> i8",
                                                                   "ui8 -> i8", "ui16 -> i8", "ui32 -> i8"};

    static constexpr std::array<TestFn, 6> ctsh_tests = {&Unit::CtshTester::i8_test,   &Unit::CtshTester::i16_test,
                                                         &Unit::CtshTester::i32_test,  &Unit::CtshTester::ui8_test,
                                                         &Unit::CtshTester::ui16_test, &Unit::CtshTester::ui32_test};

    static constexpr std::array<std::string, 6> ctsh_test_names = {"i8 -> i16",	 "i16 -> i16",	"i32 -> i16",
                                                                   "ui8 -> i16", "ui16 -> i16", "ui32 -> i16"};

    static constexpr std::array<TestFn, 6> ctsw_tests = {&Unit::CtswTester::i8_test,   &Unit::CtswTester::i16_test,
                                                         &Unit::CtswTester::i32_test,  &Unit::CtswTester::ui8_test,
                                                         &Unit::CtswTester::ui16_test, &Unit::CtswTester::ui32_test};

    static constexpr std::array<std::string, 6> ctsw_test_names = {"i8 -> i32",	 "i16 -> i32",	"i32 -> i32",
